<template>
  <el-table
    ...
    :border="true"
  >
    <el-table-column prop="target" label="O（目标）" width="300" :show-overflow-tooltip="true"></el-table-column>
    <el-table-column prop="krlist" :label="cycleName + 'KR'" width="400" class-name="borderTd">
